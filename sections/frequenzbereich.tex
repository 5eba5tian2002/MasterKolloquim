...
\begin{itemize}
    \item Verstärkung/ Dämpfung von Ein- zu Ausgang
 
    
    \item Bei $f_g$: Amplitude fällt auf $1/\sqrt{2}$ ($-3\,\mathrm{dB}$).
\end{itemize}

\cite{FreqGang:2026} \cite{Schürfer:2019}
...
% Rechte Spalte
    \begin{column}{0.45\textwidth}
        \begin{figure}
            \centering
            \includegraphics[width=0.5\textwidth]{images/AmplitudenGang.png}
            {\footnotesize \cite{ÜfuncRC:2026} \par}
            \caption{RC-Schaltung}
        \end{figure}
    \end{column}
...
Phasenverschiebung von Ein- zu Ausgangssignal
